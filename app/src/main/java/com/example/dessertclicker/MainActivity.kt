...
@Preview
@Composable
fun DessertClickerScreenPreview() {    DessertClickerTheme {
    DessertClickerScreen(
        revenue = 100, // Valor de exemplo
        dessertsSold = 20, // Valor de exemplo
        dessertImageId = R.drawable.cupcake, // Imagem de exemplo
        onDessertClicked = { /* Não faz nada no preview */ },
        modifier = Modifier
    )
}
}
